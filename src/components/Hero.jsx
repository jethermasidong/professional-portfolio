          ...
          <div className="flex-1 text-left">
            <div className="flex items-center justify-between w-full">
              <div className="flex items-center gap-2">
                ...
                <span className="flex items-center gap-2 border mt-2 border-[var(--border)] rounded-full text-[12px] py-1 px-3 font-satoshi text-[var(--muted)] bg-[var(--card)] w-fit">
            ...
            <div className="flex items-center gap-1 mt-1 mb-1 text-[var(--muted)]">
            ...
            <div className="flex w-full max-w-4xl items-center justify-between mb-3">
              <button className="group relative mt-1 pt-1 pb-1 inline-block overflow-hidden text-lg font-semibold text-black/50">
                  <span className="block text-[var(--text)]">Full-Stack Developer / Blockchain Developer</span>
              </button>
              <button
                onClick={handleThemeSwitch}
                className="relative w-14 h-8 flex items-center rounded-full border border-[var(--border)] bg-[var(--card)] px-1 transition"
              >
                <div
            ...
            <div className="flex gap-3 mt-3">
              ...
              >
                <svg className="w-3 h-3 text-[var(--text)]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
